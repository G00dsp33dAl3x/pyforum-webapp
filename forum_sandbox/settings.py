...
ALLOWED_HOSTS = ['127.0.0.1','localhost', 'web1', 'web2', 'web3', 'nginx']
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': os.path.join(BASE_DIR, 'logs', 'logs/django.log'), # Замініть шлях на реальний шлях до файлу логу помилок
        },
    },
    'loggers': {
        'django': {
